...
sqlcmd -S localhost -U SA -P 'Ophthalamia@123' -d Backgammon -Q "INSERT INTO Users (Id, Name, ShowPhoto, Elo, GameCount, Admin, EmailNotifications, EmailUnsubscribeId, Gold, LastFreeGold, PassHash, MuteIntro) VALUES ('FB5046FE-DE10-48A7-901E-E5E95251E996', 'Game', 'FALSE', 0, 0, 'FALSE', 'FALSE', 'FB5046FE-DE10-48A7-901E-E5E95251E996', 0, GETDATE(), 0, 'FALSE')"
sqlcmd -S localhost -U SA -P 'Ophthalamia@123' -d Backgammon -Q "INSERT INTO Users (Id, Name, ShowPhoto, Elo, GameCount, Admin, EmailNotifications, EmailUnsubscribeId, Gold, LastFreeGold, PassHash, MuteIntro) VALUES ('ECC9A1FC-3E5C-45E6-BCE3-7C24DFE82C98', 'Aina', 'FALSE', 0, 0, 'FALSE', 'FALSE', 'ECC9A1FC-3E5C-45E6-BCE3-7C24DFE82C98', 0, GETDATE(), 0, 'FALSE')"
```
